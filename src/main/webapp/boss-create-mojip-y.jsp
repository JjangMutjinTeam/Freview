      ...
      <form id="createPostForm" action="/mojipBoard/createPost" method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="date" class="form-control" id="applyEndDate" name="applyEndDate" required>
          </div>
        </div>
        <div class="mb-3">
          <label for="experienceDate" class="form-label">방문 날짜</label>
          <input type="date" class="form-control" id="experienceDate" name="experienceDate" required>
        </div>
        <div class="mb-3">
        ...
        <div class="d-flex justify-content-between">
          <button type="button" class="btn btn-secondary" onclick="location.href='/mojipBoard'">이전</button>
